...
prom_de_pausas <- c(3.8, 3.2, 2)
plot(prom_de_pausas, ylab="Promedio de pausas", xlab="Carácter de la composición", main ="Promedio de número de pausas", type ="b", col = c("gray", "blue", "red"), axes = FALSE, ylim=c(1,4))
box()
grid()
axis(1, at=(1:3), labels=c("0", "n", "p"))
prom_de_pausas <- c(3.8, 3.2, 2)
plot(prom_de_pausas, ylab="Promedio de pausas", xlab="Carácter de la composición", main ="Promedio de número de pausas", type ="b", col = c("gray", "blue", "red"), axes = FALSE, ylim=c(1,4))
box()
grid()
...
# Ene de pausas por estrofa

prom_de_pausas <- c(2, 3.2, 3.8)
plot(prom_de_pausas, ylab="Promedio de pausas", xlab="", main ="Promedio de número de pausas", type ="p", col = c("red", "blue", "gray"), pch=19, axes = FALSE, ylim=c(1,4))
box()
grid()
axis(1, at=(1:3), labels=c("p", "n", "0"))
axis(2, at =(0:5))
